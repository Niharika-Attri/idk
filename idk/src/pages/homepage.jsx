...
function Homepage(){
    ...
    return(
        <div className="flex relative items-center justify-center w-screen h-screen bg-[#232323] overflow-hidden" style={{backgroundImage: `url(${dots})`}}>

            <img 
                src={bggallery} 
                className="absolute w-fit h-fit object-cover overflow-hidden opacity-0 md:opacity-100 md:scale-150 lg:scale-100" 
                alt="background"
                style={{
                ...
                />
            <h1 className="font-soria text-center z-20"  >Wander through a <br/> world of  
            <motion.span className="font-fsomething text-[#F1893A]"> expression</motion.span></h1>
            <motion.svg className='absolute' width='55%'  viewBox="0 0 1006 443" fill="none" 
